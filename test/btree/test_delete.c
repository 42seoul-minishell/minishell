...
int test_delete_btree_node_lc_null(void)
{
	...
	init_btree_node(&node, 1);
	res = delete_btree_node_lc(&node);
	return res;
}
...
int test_delete_btree_node_lc(void)
{
	...
	node[0] = create_btree_node(token[0]);
	node[1] = create_btree_node(token[1]);

	node[0]->id = 2;
	node[1]->id = 1;

	node[0]->lc = node[1];
	res = delete_btree_node_lc(node[0]);
	tmp = get_btree_node_by_id(node[0], 1);
...
int test_delete_btree_node_rc(void)
{
	...
	node[0]->rc = node[1];
	res = delete_btree_node_rc(node[0]);
	tmp = get_btree_node_by_id(node[0], 1);
...
void test_delete_btree_node_chlid(void)
{
	...
	node[0] = create_btree_node(token[0]);
	node[1] = create_btree_node(token[1]);
	node[2] = create_btree_node(token[2]);
	...
	delete_btree_node_child(node[0]);
}